...
@Component({
  selector: 'app-history-total',
  templateUrl: './history-total.component.html',
  styleUrl: './history-total.component.scss'
})
export class HistoryTotalComponent implements OnChanges {
